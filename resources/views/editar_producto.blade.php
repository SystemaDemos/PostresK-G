...
@section('title', 'Editar Producto - PostresK&G')

@section('content')
    <div class="app__content">

        <header class="page-header">
            <h2 class="page-header__title">Editar Producto</h2>
            <p class="page-header__subtitle">Edita la información del producto del sistema.</p>
        </header>

        <div class="form-card">
            <form action="{{ route('productos.update', $producto->id) }}" method="POST" class="form-card__form">
                @csrf
                @method('PUT')
                <div class="form-card__row">
                    <div class="form-card__group">
                        ...
                        <input type="text" id="nombre" name="nombre" class="form-card__input"
                            value="{{ old('nombre', $producto->nombre) }}" placeholder="Ej. pan con queso" required>
                    </div>
                    ...
                    <div class="form-card__group">
                        ...
                        <input type="text" id="categoria" name="categoria" list="categorias-list"
                            class="form-card__input" value="{{ old('categoria', $producto->categoria?->nombre) }}"
                            placeholder="Ej. Panadería, Cafetería" autocomplete="off" onfocus="this.showPicker()" required>
                ...
                <div class="form-card__row">
                    <div class="form-card__group">
                        ...
                        <input type="number" id="cantidad" name="cantidad" class="form-card__input"
                            value="{{ old('cantidad', $producto->cantidad) }}" placeholder="0" min="0" required>
                    </div>
                    ...
                    <div class="form-card__group">
                        ...
                        <input type="number" id="precio" name="precio_de_venta" class="form-card__input"
                            value="{{ old('precio_de_venta', $producto->precio_de_venta) }}" placeholder="0.00"
